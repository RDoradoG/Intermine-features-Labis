/*==============================================================
=            Functionallity of Gene Atlas Displayer            =
=															   =
▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒
= Rodrigo Dorado								█║█║║█║█║█║║█  =
==============================================================*/
 ...
 * @author Rodrigo Dorado
 */
function executeDrawComparation(dataB, dataA) {
	expressionValuesA = clone(dataB);
	expressionValuesB = clone(dataA);
	drawComparation(expressionValuesB, expressionValuesA);
}
 ...
 * @author Rodrigo Dorado
 */
function drawComparation(dataB, dataA) {
	var enrichment_data = new google.visualization.DataTable();

	enrichment_data.addColumn('string', 'Condition Name', 'condition');
	enrichment_data.addColumn('number', 'Expression Value A', 'expressionValue A');
	enrichment_data.addColumn('number', 'Expression Value B', 'expressionValue B');
...
function getResult(result, idCall){
	switch (idCall.id) {
		...
		case 'Experiment_comparationA':
			this.APIExecuteQuery(idCall.data, {id: 'Experiment_comparationB', data: result});
		break;

		case 'Experiment_comparationB':
			switch (optionSelectedButton) {
				case 'compare': executeDrawComparation(result, idCall.data);break;
				case 'scatter': setScatterPlot(result, idCall.data); break;
			}
		break;
	}
}
 ...
 * @author Rodrigo Dorado
 */
function setScatterPlot(seta, setb) {
