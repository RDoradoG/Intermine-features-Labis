...
class wrapp():
	...
	def __init__(self, experimentName, shScript, experimentsFolder, numberOfSamples, PubMedId):
		...
		self.file_ExperimentDescription       = 'F-ExperimentDescription-example.txt'
		#self.file_ExperimentDescription      = 'G-ExperimentDescription-example.txt'
		self.file_ExperimentDescriptionColumn = 'H-ExperimentDescriptionColumns'
		self.file_ExpressionValues            = 'I-ExpressionValues-'
	...
	def deleteUnusefulFiles(self):
		...
		command = 'rm -r SRR* DRR* *.po* *.pe* *.o* *.e* Clean/'
