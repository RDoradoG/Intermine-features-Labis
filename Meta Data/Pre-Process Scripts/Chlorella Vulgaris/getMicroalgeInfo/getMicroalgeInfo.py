...
def getArguments(folder):
    ...
    parser.add_argument("--folder_name", help = "The name of the folder with the new files")
    ...
    parser.add_argument("--annotation_file", help = "The file with all the annotation information.")
